            ...
            <div class="column">
                            ...
                            <div class="column">
                                ...
                                <div class="row">
                                    ...
                                    <div class="column lg-6 tab-12">
                                        ...
                                        <br>
                                        <img src="{{ url('/assets/img/') }}/{{ $item->photo }}" style="height:500px; widht:auto;">
                                        <p class="desc-bride">
                                            {{ $item->child }}
                                        </p>
                                        <p>
                        ...
                        <div class="tz-gallery">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/assets/img/') }}/2.JPG">
                                        <img src="{{ url('/assets/img/') }}/2.JPG">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/assets/img/') }}/3.JPG">
                                        <img src="{{ url('/assets/img/') }}/3.JPG">
                                    </a>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <a class="lightbox" href="{{ url('/assets/img/') }}/4.JPG">
                                        <img src="{{ url('/assets/img/') }}/4.JPG" alt="Tunnel">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/assets/img/') }}/5.JPG">
                                        <img src="{{ url('/assets/img/') }}/5.JPG" alt="Coast">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/assets/img/') }}/6.JPG">
                                        <img src="{{ url('/assets/img/') }}/6.JPG" alt="Rails">
                                    </a>
                                </div>
                                <div class="col-sm-6 col-md-4">
                                    <a class="lightbox" href="{{ url('/assets/img/') }}/1.JPG">
                                        <img src="{{ url('/assets/img/') }}/1.JPG" alt="Traffic">
                                    </a>
                                </div>
                            </div>
                ...
                <footer>
                    <div class="ss-copyright">
                        <center>
                            @foreach ($wedding as $item)
                            <span>© Copyright Tupai Labs Indonesia {{date("Y")}}</span>
                            @endforeach
                        </center>
